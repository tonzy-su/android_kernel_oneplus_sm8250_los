				  ...
				  struct device_attribute *attr, char *buf)
{
	...
	if (wls_online) {
		chg_err("wls_online: %d\n", wls_online);
		if (is_wls_ocm_available(chip)) {
			chg_err("is_wls_ocm_available: %d\n", is_wls_ocm_available);
				      ...
				      struct device_attribute *attr, char *buf)
{
	...
	chg_info("ui_power_show: adapter_power=%d, project_power=%d, ufcs_online=%d, pps_online=%d , pps_or_ufcs_power=%d ui_power=%d,ui_power_by_user=%d\n",
